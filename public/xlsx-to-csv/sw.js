...
const PRECACHE_URLS = [
  '/xlsx-to-csv/',
  '/xlsx-to-csv/manifest.json',
  '/xlsx-to-csv/icon-192.png',
  '/xlsx-to-csv/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/xlsx-to-csv/manifest.json';
}
