...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/xlsx-to-csv/sw.js, scope=/xlsx-to-csv/）。
    // scope がツールの全 locale ページ（/xlsx-to-csv/, /xlsx-to-csv/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/xlsx-to-csv/sw.js', {
      scope: '/xlsx-to-csv/',
    });
